    ...
    <div>
      ...
      <header className="container mx-auto flex flex-wrap px-16 md:flex-no-wrap mb-16">
        ...
        <div className="md:pl-16 w-full">
          ...
          <p>
            BTC, ETH conversion rates updated every 12 hours at 00:00 and 12:00
            UTC
          </p>
        </div>
      </header>
      ...
      <section className="container mx-auto px-16 py-12 mb-16">
        ...
        <p>
          ...
          MNT tokens in their account. Crypto mined with hashing power received
          for holding MNT is held in users IslandEX Wallet. Users have the
          option to trade the Bitcoin (or other crypto) held in their wallet for
          fiat currency through IslandEX Exchange. Users can hold fiat at
          IslandEX and use a prepaid debit card issued through IslandEX or one
          of its banking affiliates, to easily spend their funds.
        </p>
      </section>
      ...
      <section id="application" className="container mx-auto px-16 py-12 mb-16">
        ...
        <div className="text-center mb-16">
          <h2 className="heading-secondary">
            ...
            KYC (Know Your Customer) process. To complete your registration for
            the token sale, please click the link below.
          </h2>
        ...
        <div className="w-full md:w-2/3 mx-auto">
          ...
          <p>
            Processing may take up to 5-10 minutes. Please refresh your page to
            check on your registration progress.
          </p>
        </div>
      </section>
