        ...
        <div className="row d-flex flex-wrap align-items-center">
          ...
          >
            <header className="fancy-title mb-50">
              <FancyScrollAnimation className="appearHeader" isAllChildren={true} childrenClassNames="animateHeaders">
            ...
            <FancyScrollAnimation className="appearText" isAllChildren={true} childrenClassNames="animateHeaders">
