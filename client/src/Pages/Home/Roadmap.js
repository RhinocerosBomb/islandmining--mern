...
function Roadmap() {
  return (
    <section
      ...
      style={{ backgroundImage: "url(./assets/demo/bg/bg-40.jpg)" }}
    >
      ;
              ...
              <div className="one-roadmap-inner">
                ...
                <div className="one-roadmap-item text-white">
                  ...
                  <div className="one-roadmap-info">
                    ...
                    <p>
                      <strong>
                        -&nbsp;&nbsp;Initiate token sale Pre-Sale Round + Public
                        Sale 1 + 2
                      </strong>
                      <br />
                      ...
                      B)
                      <br />
                      -&nbsp;&nbsp;Falcon Series liquid-cooled ASIC miner launch
                      <br />
                ...
                <div className="one-roadmap-item text-white">
                  ...
                  <div className="one-roadmap-info">
                    ...
                    <p>
                      <strong>
                        -&nbsp;&nbsp;Token sale completed and Mining Coin tokens
                        unlocked
                      </strong>
                      <br />
